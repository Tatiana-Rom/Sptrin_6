...
class OrderPageLocators:
    ...
    input_count_rent_day = (By.XPATH, '//div[contains(@class, "Dropdown-placeholder")]')
    list_count_rent_day = (By.XPATH, '//div[contains(@class, "Dropdown-option") and text()="{}"]')
    ...
    title_order_add = (By.XPATH, '//div[contains(text(),"Заказ оформлен")]')
